...
Importing a template is a quick way to use a template that someone else has already created.  Templates can be large, and manually inputting all the details can be tedious.  I've included [a template](./assets/IoTConnect/RASynBoard_template.JSON) that works with the OOB application in this GitHub repo.  You can also manaully edit an existing template, it's just a JSON document.  However, editing templates is beyond the scope of this document.

1. Click on the **Import** button in the upper right hand corner

![](./assets/iotcImport.jpg "")

2. The **Import** dialog opens
    1. Use the **Browse** link to find the ```/docs/assets/IoTConnect/RASynBoard_template.JSON``` file
    1. Click the **Save** button

![](./assets/iotcImport1.jpg "")
...
![](./assets/iotcCreateTemplate1.jpg "")
...
3. Now we can update the template and tell it about the telemetry items we'll send from the OOB application.  
    ...
    ![](./assets/iotcCreateTemplatemsgCnt.jpg "")

    2. Add the two more attributes using the details shown below 

    ![](./assets/iotcCreateTemplateInferenceIdx.jpg "")

    ![](./assets/iotcCreateTemplateInferenceStr.jpg "")
    ...
    ![](./assets/iotcCreateTemplateAttributes.jpg "")
...
![](./assets/iotcKeyVault1.jpg "")

![](./assets/iotcKeyVault2.jpg "")
...
![](./assets/iotcDemo5.jpg "")

![](./assets/iotcDemo6.jpg "")
