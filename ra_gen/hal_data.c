...
transfer_info_t g_transfer1_info = { .transfer_settings_word_b.dest_addr_mode =
		...
		TRANSFER_MODE_BLOCK, .p_dest = (void*) 0, .p_src =
		(void const*) USB_SRC_ADDRESS, .num_blocks = 0, .length = 0, };
const dmac_extended_cfg_t g_transfer1_extend = { .offset = 0, .src_buffer_size =
		1,
...
#endif
		.ipl = (3), .channel = 1, .p_callback = NULL, .p_context = NULL,
...
transfer_info_t g_transfer0_info = { .transfer_settings_word_b.dest_addr_mode =
		...
		TRANSFER_SIZE_2_BYTE, .transfer_settings_word_b.mode =
		TRANSFER_MODE_BLOCK, .p_dest = (void*) USB_DEST_ADDRESS, .p_src =
		(void const*) 0, .num_blocks = 0, .length = 0, };
const dmac_extended_cfg_t g_transfer0_extend = { .offset = 0, .src_buffer_size =
    ...
    .irq                 = VECTOR_NUMBER_DMAC0_INT,
		...
		.irq = FSP_INVALID_VECTOR,
#endif
		.ipl = (3), .channel = 0, .p_callback = usb_ip0_d1fifo_callback,
		.p_context = NULL, .activation_source = ELC_EVENT_USBFS_FIFO_1, };
...
const usb_cfg_t g_basic_cfg = { .usb_mode = USB_MODE_PERI, .usb_speed =
		USB_SPEED_FS, .module_number = 0, .type = USB_CLASS_PMSC,
#if defined(g_usb_descriptor)
...
#endif
		.ipl = (13), .ipl_r = (13), .ipl_d0 = (13), .ipl_d1 = (13), .hsipl =
				(BSP_IRQ_DISABLED), .hsipl_d0 = (BSP_IRQ_DISABLED), .hsipl_d1 =
				(BSP_IRQ_DISABLED),
#if (BSP_CFG_RTOS != 0)
...
/* Instance structure to use this module. */
const usb_instance_t g_basic = { .p_ctrl = &g_basic_ctrl, .p_cfg = &g_basic_cfg,
		.p_api = &g_usb_on_usb, };

lpm_instance_ctrl_t g_lpm0_ctrl;

const lpm_cfg_t g_lpm0_cfg = { .low_power_mode = LPM_MODE_STANDBY,
		.standby_wake_sources = LPM_STANDBY_WAKE_SOURCE_IRQ5
...
const uart_cfg_t g_uart3_cfg = { .channel = 3, .data_bits = UART_DATA_BITS_8,
		.parity = UART_PARITY_OFF, .stop_bits = UART_STOP_BITS_1, .p_callback =
				rm_atcmd_uart_callback, .p_context = NULL, .p_extend =
				&g_uart3_cfg_extend,
#define RA_NOT_DEFINED (1)
...
const uart_instance_t g_uart3 = { .p_ctrl = &g_uart3_ctrl,
		.p_cfg = &g_uart3_cfg, .p_api = &g_uart_on_sci };
...
void g_spi1_master_tx_transfer_callback (dmac_callback_args_t * p_args)
{
    FSP_PARAMETER_NOT_USED(p_args);
    spi_tx_dmac_callback(&g_spi1_master_ctrl);
}
#endif
...
void g_spi1_master_rx_transfer_callback (dmac_callback_args_t * p_args)
{
    FSP_PARAMETER_NOT_USED(p_args);
    spi_rx_dmac_callback(&g_spi1_master_ctrl);
}
#endif
#undef RA_NOT_DEFINED

spi_instance_ctrl_t g_spi1_master_ctrl;

/** SPI extended configuration for SPI HAL driver */
const spi_extended_cfg_t g_spi1_master_ext_cfg = { .spi_clksyn =
...
const spi_cfg_t g_spi1_master_cfg = { .channel = 1,
    ...
    .eri_irq             = VECTOR_NUMBER_SPI1_ERI,
		...
		.rxi_ipl = (9), .txi_ipl = (10), .tei_ipl = (12), .eri_ipl = (12),
		...
		.mode_fault = SPI_MODE_FAULT_ERROR_DISABLE, .bit_order =
				...
				g_spi1_master_P_TRANSFER_TX, .p_transfer_rx =
				g_spi1_master_P_TRANSFER_RX, .p_callback = spi1_master_callback,

		.p_context = NULL, .p_extend = (void*) &g_spi1_master_ext_cfg, };

/* Instance structure to use this module. */
const spi_instance_t g_spi1_master = { .p_ctrl = &g_spi1_master_ctrl, .p_cfg =
		&g_spi1_master_cfg, .p_api = &g_spi_on_spi };
...
const uart_cfg_t g_uart4_cfg = { .channel = 4, .data_bits = UART_DATA_BITS_8,
		.parity = UART_PARITY_OFF, .stop_bits = UART_STOP_BITS_1, .p_callback =
				console_callback, .p_context = NULL, .p_extend =
				&g_uart4_cfg_extend,
#define RA_NOT_DEFINED (1)
#if (RA_NOT_DEFINED == RA_NOT_DEFINED)
		.p_transfer_tx = NULL,
...
const uart_instance_t g_uart4 = { .p_ctrl = &g_uart4_ctrl,
		.p_cfg = &g_uart4_cfg, .p_api = &g_uart_on_sci };
